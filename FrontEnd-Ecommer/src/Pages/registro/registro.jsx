...
export default function Registro() {
  ...
  return (
      ...
      <div class="sign-up-popup-desktop">
  <img class="rectangle-1084" src={imagen1} />
  <div class="left">
    <div class="image-placeholder">
      <img class="paste-image" src={imagen2} />
      <div class="logo-negativo-2">
        <img class="tech-solutions-2" src={imagen3} />
        <div class="logo-name">
          <div class="hardtech">
            <span>
        ...
        <div class="form-input">
          <div class="content2">
            <div class="content3">
              ...
              <svg
                class="huge-icon-interface-outline-eye"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
  ...
  <div class="button2">
    <svg
      class="social-icons-facebook-original"
      width="28"
      height="28"
      viewBox="0 0 28 28"
      fill="none"
    ...
    >
      <g clip-path="url(#clip0_294_3772)">
        <path
          d="M28 14C28 6.26808 21.7319 0 14 0C6.26808 0 0 6.26808 0 14C0 20.5654 4.52032 26.0747 10.6182 27.5878V18.2784H7.73136V14H10.6182V12.1565C10.6182 7.39144 12.7747 5.1828 17.453 5.1828C18.34 5.1828 19.8705 5.35696 20.4966 5.53056V9.40856C20.1662 9.37384 19.5922 9.35648 18.8793 9.35648C16.5838 9.35648 15.6968 10.2262 15.6968 12.4869V14H20.2698L19.4841 18.2784H15.6968V27.8975C22.629 27.0603 28.0006 21.1579 28.0006 14H28Z"
          fill="#0866FF"
        />
        <path
          d="M19.4837 18.2783L20.2694 13.9999H15.6964V12.4868C15.6964 10.2261 16.5834 9.35642 18.8789 9.35642C19.5918 9.35642 20.1658 9.37378 20.4962 9.4085V5.5305C19.8701 5.35634 18.3396 5.18274 17.4526 5.18274C12.7743 5.18274 10.6178 7.39138 10.6178 12.1564V13.9999H7.73096V18.2783H10.6178V27.5878C11.7008 27.8566 12.8337 27.9999 13.9996 27.9999C14.5736 27.9999 15.1398 27.9647 15.6958 27.8975V18.2783H19.4831H19.4837Z"
          fill="white"
        />
      </g>
      <defs>
  ...
  <div class="button3">
    <div class="social-icons-google-original">
      ...
      >
        <path
          d="M14.4995 11.4545V16.8763H22.034C21.7032 18.6199 20.7103 20.0963 19.2213 21.0891L23.7649 24.6145C26.4122 22.171 27.9394 18.5819 27.9394 14.3182C27.9394 13.3255 27.8504 12.3709 27.6849 11.4546L14.4995 11.4545Z"
          fill="#4285F4"
        />
        <path
          d="M6.65355 16.6647L5.6288 17.4491L2.00146 20.2745C4.3051 24.8436 9.02656 28 14.4992 28C18.2792 28 21.4482 26.7527 23.7646 24.6146L19.221 21.0891C17.9737 21.9291 16.3828 22.4382 14.4992 22.4382C10.8593 22.4382 7.76663 19.9819 6.65928 16.6728L6.65355 16.6647Z"
          fill="#34A853"
        />
        <path
        ...
        />
        <path
          d="M14.4995 5.57454C16.5614 5.57454 18.3941 6.28725 19.8577 7.66181L23.8668 3.65277C21.4358 1.38736 18.2796 0 14.4995 0C9.02685 0 4.3051 3.14363 2.00146 7.72546L6.65958 11.34C7.76679 8.03089 10.8596 5.57454 14.4995 5.57454Z"
          fill="#EA4335"
        />
      </svg>
    </div>
